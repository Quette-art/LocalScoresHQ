const TEAM_PROFILE_LOGOS = new Map([
  ...
  ["Riverdale Baptist", "/mascots/riverdale-baptist.svg?v=exact-existing-picture-4"],
  ["Riverdale Baptist School", "/mascots/riverdale-baptist.svg?v=exact-existing-picture-4"],
]);
