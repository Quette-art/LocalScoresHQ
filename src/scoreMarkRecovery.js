const SCORE_MARKS = new Map([
  ...
  ["Mt. Zion", "/mascots/score-marks/mt-zion-prep-mzp.svg?v=exact-created-restore-1"],
  ["Mt. Zion Prep", "/mascots/score-marks/mt-zion-prep-mzp.svg?v=exact-created-restore-1"],
  ["Mt. Zion Prep Academy", "/mascots/score-marks/mt-zion-prep-mzp.svg?v=exact-created-restore-1"],
  ["Riverdale Baptist", "/mascots/score-marks/riverdale-baptist-rbs.svg?v=exact-created-restore-1"],
  ["Riverdale Baptist School", "/mascots/score-marks/riverdale-baptist-rbs.svg?v=exact-created-restore-1"],
]);
